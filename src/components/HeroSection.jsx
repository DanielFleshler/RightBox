...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="relative min-h-[100dvh] overflow-hidden bg-brandbg bg-cover bg-no-repeat [background-blend-mode:multiply] bg-[position:50%_25%] md:bg-[position:50%_50%] flex items-center text-textlight"
    ...
    >
      ...
      <div className="container relative z-10 mx-auto w-full px-4">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-8 text-center">
          ...
          <p className="max-w-[50ch] text-base sm:text-lg md:text-xl text-muted/90">
            ציוד פרימיום לחובבי שטח שמבקשים אמינות, עמידות ונוחות — מותאם לכל תנאי השטח
            בישראל.
          </p>

          <div className="flex w-full max-w-[800px] flex-wrap items-center justify-center gap-8">
            {/* Feature 1 */}
            <div className="flex flex-row-reverse items-center gap-3 text-right">
              <span className="grid h-12 w-12 flex-shrink-0 place-items-center rounded-full border-2 bg-accent/10 text-accent border-accent/30" aria-hidden>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 3l8 4v5c0 5-3.5 9-8 9s-8-4-8-9V7l8-4Z" stroke="currentColor" strokeWidth="2" />
            ...
            {/* Feature 2 */}
            <div className="flex flex-row-reverse items-center gap-3 text-right">
              <span className="grid h-12 w-12 flex-shrink-0 place-items-center rounded-full border-2 bg-sand/10 text-sand border-sand/30" aria-hidden>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 5v14M12 3v18M20 7v10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
              ...
              <div>
                ...
                <div className="text-sm text-muted">תכנון וייצור לפי הרכב והצרכים</div>
              </div>
            </div>
            ...
            <div className="flex flex-row-reverse items-center gap-3 text-right">
              <span className="grid h-12 w-12 flex-shrink-0 place-items-center rounded-full border-2 bg-accent/10 text-accent border-accent/30" aria-hidden>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 14l5-5m2 7l-2-2M6 7l3 3" stroke="currentColor" strokeWidth="2" />
                  <path d="M20 14v5h-5M4 10V5h5" stroke="currentColor" strokeWidth="2" />
                </svg>
              </span>
              <div>
      ...
      <a
        href="#carousel"
        className="absolute bottom-10 left-1/2 grid h-14 w-14 -translate-x-1/2 place-items-center rounded-full border border-white/20 bg-accent/10 text-textlight transition-transform hover:-translate-y-1 animate-bounce"
